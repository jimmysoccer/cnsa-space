          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="tech-card">
                ...
                <h3 className="text-xl font-orbitron font-bold mb-4 text-center">推进系统</h3>
                <div className="space-y-4 text-space-light/80">
                  ...
                  <div className="border-t border-space-accent/20 pt-4">
                    <h4 className="font-orbitron text-space-accent mb-2 text-sm uppercase">技术</h4>
                  ...
                  <div className="border-t border-space-accent/20 pt-4">
                    <h4 className="font-orbitron text-space-accent mb-2 text-sm uppercase">当前应用</h4>
                    <p>
              ...
              <div className="tech-card">
                ...
                <h3 className="text-xl font-orbitron font-bold mb-4 text-center">通讯系统</h3>
                <div className="space-y-4 text-space-light/80">
                  <p>
                    我们的深空通信网络可实现数十亿公里外的可靠数据传输。
                  </p>
                  <div className="border-t border-space-accent/20 pt-4">
                    <h4 className="font-orbitron text-space-accent mb-2 text-sm uppercase">技术</h4>
                    <ul className="list-disc list-inside space-y-1">
              ...
              <div className="tech-card">
                ...
                <h3 className="text-xl font-orbitron font-bold mb-4 text-center">生命保障系统</h3>
                <div className="space-y-4 text-space-light/80">
                  <p>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="bg-space-secondary/40 rounded-lg p-4 border border-space-accent/20">
                    <h4 className="font-orbitron text-space-light mb-2">关键优势</h4>
                  ...
                  <div className="bg-space-secondary/40 rounded-lg p-4 border border-space-accent/20">
                    <h4 className="font-orbitron text-space-light mb-2">开发状态</h4>
