    ...
    return (
      <div className="min-h-screen pt-16 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-space-light/80 mb-6">无法找到ID为 "{techId}" 的技术</p>
          <Link to={NavBarItemsObj.technology.path}>
            <Button variant="outline" className="bg-space-accent/20 hover:bg-space-accent/30 border border-space-accent/30">
              返回技术页面
            </Button>
          </Link>
        </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="bg-space-dark/70 backdrop-blur-sm border border-space-accent/20 col-span-full">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-xl font-orbitron font-semibold">发展历史</h2>
                </div>
            ...
            <Card className="bg-space-dark/70 backdrop-blur-sm border border-space-accent/20 col-span-full">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-xl font-orbitron font-semibold">当前进展</h2>
                </div>
                <p className="text-space-light/80">{technology.currentProgress}</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-space-dark/70 backdrop-blur-sm border border-space-accent/20 col-span-full md:col-span-2">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-xl font-orbitron font-semibold">当前应用</h2>
                </div>
            ...
            <Card className="bg-space-dark/70 backdrop-blur-sm border border-space-accent/20 col-span-full md:col-span-1">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-xl font-orbitron font-semibold">未来改进</h2>
                </div>
                <ul className="space-y-2">
            ...
            <Card className="bg-space-dark/70 backdrop-blur-sm border border-space-accent/20 col-span-full">
              <CardContent className="p-6">
                <h2 className="text-xl font-orbitron font-semibold mb-4">优势与挑战</h2>
