...
export const TECHNOLOGIES: Technology[] = [
  {
    ...
    name: "量子真空推进",
    description: "我们革命性的推进系统利用太空真空中的量子波动能量，实现前所未有的效率和加速能力，不受传统推进剂限制。",
    history: "量子真空推进技术起源于20世纪末对量子场理论和卡西米尔效应的研究。早期理论工作由卡迈克尔·库拉教授于2022年开始，首个实验原型在2028年由问天阁研究团队成功研发。",
    currentProgress: "目前处于先进测试阶段，小型原型在真空室条件下实现0.1g加速度。全尺寸实施计划用于欧罗巴探索者任务。",
    currentApplications: [
      "小型卫星轨道调整系统",
      "深空探测器辅助推进",
      "长距离行星际探测任务"
  ...
  },
  {
    id: "ion-propulsion",
    name: "离子推进引擎",
    description: "利用电场加速带电粒子产生推力的高效率推进系统，适合长期太空任务。",
    history: "离子推进技术概念早在20世纪初就被提出，但直到1964年才有首个实用系统在卫星上测试。中国航天在2020年开始大规模投入离子推进系统研发。",
    currentProgress: "当前已实现5N推力系统的常规化部署，燃料效率达到90%，使用氙气或氪气作为推进剂。",
    currentApplications: [
      "深空探测任务主要推进系统",
      "地球轨道卫星姿态控制",
      "小行星采矿设备推进系统"
  ...
  },
  {
    ...
    name: "量子纠缠通信",
    description: "利用量子纠缠现象实现即时通信的革命性技术，不受传统电磁波传播延迟限制。",
    history: "量子纠缠现象早在20世纪初被爱因斯坦称为"幽灵般的超距作用"，2030年中国科学家首次实现了稳定的量子纠缠信息传输。",
    currentProgress: "已在近地轨道实现稳定的量子密钥分发系统，正在开展月球-地球量子通信实验。",
    currentApplications: [
      "近地空间绝对安全通信",
      "军事战略指挥系统",
      "极度安全的金融交易网络"
