...
import { Calendar, Clock, ArrowUpCircle, CheckCircle, AlertCircle } from 'lucide-react';
      ...
      case 'planned':
        return (
          <div className="flex items-center">
            ...
            <span className="text-xs px-2 py-0.5 rounded-full bg-yellow-500/20 text-yellow-300">计划中</span>
          </div>
        );
      case 'in-progress':
        return (
          <div className="flex items-center">
            ...
            <span className="text-xs px-2 py-0.5 rounded-full bg-green-500/20 text-green-400">进行中</span>
          </div>
        );
      case 'completed':
        return (
          <div className="flex items-center">
            ...
            <span className="text-xs px-2 py-0.5 rounded-full bg-blue-500/20 text-blue-300">已完成</span>
          </div>
        );
      case 'delayed':
        return (
          <div className="flex items-center">
            ...
            <span className="text-xs px-2 py-0.5 rounded-full bg-red-500/20 text-red-400">已延期</span>
          </div>
        );
      default:
